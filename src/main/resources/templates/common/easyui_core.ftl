...
<script type="text/javascript" src="${urls.getForLookupPath('/js/jquery-1.11.1.min.js')}" ></script>

<script type="text/javascript" src="${urls.getForLookupPath('/js/hz.js')}" ></script>

<script type="text/javascript" src="${urls.getForLookupPath('/jquery-easyui-1.4/jquery.easyui.min.js')}"></script>
...
<link href="${urls.getForLookupPath('/jquery-easyui-1.4/themes/icon.css')}" rel="stylesheet" type="text/css" />
