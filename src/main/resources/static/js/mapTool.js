function MapTool(box, map,mData) {
    ...
    var loadEvent = function () {
        ...
        $("#ElecAlarmSum").find(".numItem").click(function () {
            ...
            doAction("SElec/DetailElecAlarm", "GET", { Status: tt }, function (result) {
                var pResult = $(".queryResult");
                pResult.empty();
        ...
        $("#ElecDeviceSum").find(".numItem").click(function () {
            ...
            doAction("SElec/DetailElecDevice", "GET", { Status: tt }, function (result) {
                var pResult = $(".queryResult");
                pResult.empty();
    ...
    var DeviceClick = function (pobj, comObj, data) {
        ...
        pobj.click(function () {
            ...
            window.top.OpenThirdFrame("/ExtApp/SElectric/ElecDetail?devBH=" + data.BH, 800, 600, "win", comObj.MC + "(" + data.Text + ")");
        });
    }

    //加载报警趋势图表
    var loadChart = function () {
        doAction("SElec/SumElecByTime", "GET", {}, function (result) {
